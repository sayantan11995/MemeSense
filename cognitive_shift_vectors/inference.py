...
def main(cfg: DictConfig):
    ...
    with open("/home/student/sayantan/safety_llm/cognitive_shift_vectors/icv_src/icv_datasets/memeguard_validation_intervention_images_relevant_mapping_idx_commonsense_anchored.json", "r") as content:
        validation_images_relevant_mapping_idx = json.load(content)
    ...
    if cfg.test_icv:
        ...
        print(
            f"""prompt_manager: {prompt_manager}, interface: {interface}, processor: {processor}
                model_cpk_dir: {model_cpk_dir}
"""
        )
    else:
        ...
        for shot_num in cfg.few_shot_list:
            if cfg.use_rice:
                ...
                for i in range(len(val_ds)):
                    ...
                    # print(i)
                    ice_idx =validation_images_relevant_mapping_idx[str(i)][:shot_num]
